...
- [ ] `operator list` - 列出所有軌道營運業者
- [ ] `operator info <operator-id>` - 顯示特定營運業者資訊
- [ ] `operator --filter "OperatorCode=THSR"` - 過濾營運業者
...
| /v2/Rail/THSR/ODFare | ✅ 已確認 | ✅ 已實現 | ✅ 已驗證 | 核心功能 |
| /v2/Rail/Operator | ✅ 已確認 | ❌ 未實現 | ⏳ 待實現 | 營運業者 |
